...
namespace GamerDashBoard.Util
{
    ...
    public class FirewallHelper
    {
        ...
        {
            string ProgramIDOpenPort = "HNetCfg.FWOpenPort";
            Type type = Type.GetTypeFromProgID(ProgramIDOpenPort);
            INetFwOpenPort fwport = Activator.CreateInstance(type) as INetFwOpenPort;

            INetFwOpenPorts fwports;

            fwport.Port = port; /* port no */
            fwport.Name = name; /*name of the application using the port */
            fwport.Enabled = true; /* enable the port */
            ...
            fwports = (INetFwOpenPorts)mgr.LocalPolicy.CurrentProfile.GloballyOpenPorts;
        ...
        public void ClosePort(int port)
        {
            ...
            fwports.Remove(port,NET_FW_IP_PROTOCOL_.NET_FW_IP_PROTOCOL_TCP);
        }
